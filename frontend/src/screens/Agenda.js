...
import { FaPlay, FaPause, FaWpforms, FaSignOutAlt } from 'react-icons/fa'
...
export default class Agenda extends Component {
  ...
  getSalas = async () => {
    try {
      ...
      this.setState({ selectedSala: resSalas.data[0] ? resSalas.data[0].id : null })
    ...
    return (
      ...
      <div className="content-expanded ">
        ...
        <div className="control-buttons">
          ...
          {this.state.loggedUser && this.state.loggedUser.idnadmin ? <Link className="px-2 pt-2 pt-sm-1" to="/cadastro"><FaWpforms /></Link> : null}
          <div className="border-left px-2 pt-2 pt-sm-1" >{this.state.loggedUser ? this.state.loggedUser.nome : null}</div>
          <div className="pr-2 pt-2 pt-sm-1" onClick={() => this.logOut()}><FaSignOutAlt /></div>
        </div>
        ...
        {
          this.state.showModal && this.state.loggedUser && this.state.loggedUser.idnadmin ? <Modal clickOutside={this._closeModal} >
